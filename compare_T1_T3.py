...
Inputs (produced by mid_analysisNEWEST.py):
    T1: ~/pegasus/MID_Analysis_Output/roi_analysis/AIns_RT_merged.csv
    T3: ~/pegasus/MID_Analysis_Output_T3/roi_analysis/AIns_RT_merged.csv

Outputs (in ~/pegasus/MID_Compare_T1_T3/):
...
# ── CONFIG ────────────────────────────────────────────────────────────────
T1_MERGED = Path("~/pegasus/R_AIns_MID_Analysis_Output/roi/AIns_RT_merged.csv") #editHere
T3_MERGED = Path("~/pegasus/R_AIns_MID_Analysis_Output_T3/roi/AIns_RT_merged.csv") #editHere

OUT_DIR = Path("~/pegasus/R_AIns_MID_Compare_T1_T3") #editHere
